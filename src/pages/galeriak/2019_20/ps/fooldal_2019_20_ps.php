  ...
  <div class="cell medium-9 medium-cell-block-y">
      ...
      <div class="headers">
          <div class="scroller">
              <ul class="menu simple">
                  <li class="is-active"><a href="{{root}}galeriak/2019_20/ps/fooldal_2019_20_ps.php"
                          style="padding: 0.7rem 1rem;">Székhely</a></li>
                  <li style="padding: 0.7rem 1rem;"><a
                          href="{{root}}galeriak/2019_20/bs/fooldal_2019_20_bs.php">Tagiskola</a></li>
              </ul>
          </div>
      </div>
      ...
      {{> galeria_fooldal_fix_part_ps_2019_20}}
